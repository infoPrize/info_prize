...
<body>
    ...
    <form action="${website}InternetPlus/listByCondition/1" method="post">
        <table>
            ...
            <tr>
                <input type="button" value="选择" type="submit" onclick="form.action='${website}InternetPlus/listByCondition/1';form.submit();"/>
                <input type="button" value="导出Excel" type="submit" onclick="form.action='/export/internetPlus';form.submit();"/>
            </tr>
        </table>
