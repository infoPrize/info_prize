                            ...
                            <table id="datatable" class="table table-striped table-bordered text-center">
                                ...
                                <c:forEach items="${list}" var="list">
                                    <tr>
                                        ...
                                        <td><a href="/thesis/delete/material/${list.id}/${acmPrizeDto.id}">删除</a></td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
                            <form action="/thesis/upload/${acmPrizeDto.id}" enctype="multipart/form-data" method="post">
                                <input type="file" name="file">
                                <input type="submit" value="上传材料" id="upload">
                            </form>
                            <br>
                            <a href="/thesis/down/${acmPrizeDto.id}" id="download">下载</a>
                            ${message}
                        </div>
                    </div>
                </div>
