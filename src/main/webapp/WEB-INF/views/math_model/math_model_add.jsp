        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <hr/>
                    <form action="${website}import/math" enctype="multipart/form-data" method="post" class="dinline">
                        ...
                        <a href="${staticWebsite}resources/Math.xls" id="download_model">下载excel模板</a>
                    </form>
                </div>
            </div>
        </div>
