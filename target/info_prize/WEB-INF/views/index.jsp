...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${staticWebsite}resources/skin/qingxin/skin.css" id="layout-skin" />
	...
	<body>
		<div class="layout-admin">
			<header class="layout-header">
				<span class="header-logo">信息科学与技术学院奖项查询系统</span>
			...
			<div class="layout-footer">@信息科学与技术学院奖项统计系统</div>
		</div>
